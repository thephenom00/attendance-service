...
//            System.out.println("✅ School created: " + school.getName() + " - " + school.getAddress());
//
//            // List of Trainings
...
//            trainingRepository.saveAll(trainings);
//
//            System.out.println("✅ Children assigned to trainings:");
//
//            trainings.forEach(training -> {
//                System.out.println("   - " + training.getName() + " has " + training.getChildren().size() + " children");
//            });
//
//            // Create Trainers
...
//
//            trainings.forEach(training -> {
//                System.out.println("   - " + training.getName() + " has " + training.getTrainers().size() + " trainers");
//            });
//
//
